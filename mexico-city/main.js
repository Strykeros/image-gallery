...
"../shanghai/shanghai.html", "../sao-paulo/sao-paulo.html", "../cairo/cairo.html"];
...
"resources/img12.jpg"];
let menuButtonTexts = ["Home", "Tokyo", "Delhi", "Shanghai", "São Paulo", "Cairo"];
let slideIndex = 1;
let section;
...
function initializeSectionHeader(){
  ...
  h1.innerHTML = "Mexico City";
  section.appendChild(h1);
  let hr = document.createElement("hr");
  section.appendChild(hr);
  let p = document.createElement("p");
  p.innerHTML = "Mexico City is the capital and largest city of Mexico and the most populous city in North America. Mexico City is one of the most important cultural and financial centers in the world. It is located in the Valley of Mexico (Valle de México), a large valley in the high plateaus in the center of Mexico, at an altitude of 2,240 meters (7,350 ft). The city has 16 subdivisions known as boroughs or demarcaciones territoriales. The 2020 population for the city proper was 9,209,944, with a land area of 1,485 square kilometers (573 sq mi). According to the most recent definition agreed upon by the federal and state governments, the population of Greater Mexico City is 21,804,515, which makes it the second-largest metropolitan area in the Western Hemisphere (behind São Paulo, Brazil), the eleventh-largest agglomeration (2017), and the largest Spanish-speaking city in the world.";
...
function imgList() {
  ...
  for(let i = 0; i < 12; i++) {
      elements.push({imgSrc: imageArray[i], imgFunc: currentSlide.bind(null, overflowVal, i + 1, "image")});
      overflowVal += 70;
  }
...
function modalRowList() {
  ...
  for(let i = 0; i < 12; i++) {
      modalRowElements.push({imgSrc: imageArray[i], imgFunc: currentSlide.bind(null, overflowVal, i + 1, "image")});
      overflowVal += 70;
  }
