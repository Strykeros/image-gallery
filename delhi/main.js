...
let menuA;  
let expanded = false;
let hrefs = ["../index.html", "../tokyo/tokyo.html", "../shanghai/shanghai.html", 
...
"resources/img12.jpg"];
let menuButtonTexts = ["Home", "Tokyo", "Shanghai", "São Paulo", "Mexico City", "Cairo"];
let slideIndex = 1;
let section;
